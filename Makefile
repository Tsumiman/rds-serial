...
rds-debug: rds.cpp main.cpp verifiers/verifiers.h verifiers/*.hpp graph/*.hpp graph/*.cpp graph/*.h
	$(CXX) graph/graph.cpp graph/graph_adjacency.cpp graph/graph_matrix.cpp graph/orders.cpp rds.cpp main.cpp -g -lm -o rds -Wall -Wextra -std=c++11 -Wno-unused-parameter -fopenmp
